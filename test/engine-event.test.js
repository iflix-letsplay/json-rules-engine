...
describe('Engine: event', () => {
  ...
  context('rule events: json serializing', () => {
    ...
    it('serializes properties', async () => {
      ...
      let expected = '{"conditions":{"result":true,"priority":1,"any":[{"result":true,"operator":"greaterThanInclusive","value":21,"fact":"age","factResult":21},{"result":false,"operator":"equal","value":true,"fact":"qualified","factResult":false}]},"event":{"type":"setDrinkingFlag","params":{"canOrderDrinks":true}},"priority":100,"result":true}'
